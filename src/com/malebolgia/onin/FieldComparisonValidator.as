package com.malebolgia.onin
{
	...
	/**
	 * this is how to use this <validators:FieldComparisonValidator id="valConfirmEmail" source="{txtEmailAddressConfirm}" property="text" destination="{txtEmailAddress}" destinationProperty="text" required="true" />
	 * <p>
	 ...
	 * </p>
	 */
	public class FieldComparisonValidator extends StringValidator
	{	
		// Static constants.
		...
		override protected function doValidation( value : Object ) : Array
	    {
			...
			if( sourceValue != destValue )
			{
				var mismatch : ValidationResult =
					new ValidationResult( true,	String( value ), ERROR_CODE, ERROR_MESSAGE );
